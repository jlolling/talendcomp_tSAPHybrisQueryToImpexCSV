...
public class BasicDataType {
	...
	public static int ORACLE_ROWID = -100;
	...
	public static int getBasicTypeByTypes(int type) {
		...
		} else if (type == Types.NUMERIC || type == Types.FLOAT || type == Types.REAL || type == Types.DOUBLE
				|| type == Types.DECIMAL) {
		...
		} else if (type == Types.CLOB || type == Types.NCLOB || type == Types.LONGNVARCHAR
	...
	public static int getBasicTypeByName(String typeName) {
		...
		if (typeName.equals("CLOB")) {
			...
			return BasicDataType.DATE.getId();
		} else if (typeName.equals("BOOL") || typeName.equals("BOOLEAN") || typeName.equals("BIT")) {
			return BasicDataType.BOOLEAN.getId();
	 ...
	 * @return Basic-Type
	 */
	public static BasicDataType getBasicTypeObjectByName(String typeName) {
		typeName = typeName.toUpperCase();
		if (typeName.equals("CLOB")) {
			return BasicDataType.CLOB;
		} else if (typeName.contains("CHAR") || typeName.contains("TEXT")) {
